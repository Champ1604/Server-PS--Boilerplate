...
let shop = [
	['Lenny', 'Buys a lenny for you to enjoy!', 5],
 ...
 */
function handleBoughtItem(item, user, cost, lenny1) {
	if (item === 'symbol') {
	...
	let msg = '**' + user + " gets a lenny! " + lenny1 + ".**";
		Rooms.rooms.lennybuys.add('|c|~Shop Alert|' + msg);
		Rooms.rooms.lennybuys.update();
